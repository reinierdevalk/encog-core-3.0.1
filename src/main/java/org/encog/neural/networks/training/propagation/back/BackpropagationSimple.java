 ...
 */
public class BackpropagationSimple extends Propagation implements Momentum,
		LearningRate {
	 ...
	 */
	public BackpropagationSimple(final ContainsFlat network, final MLDataSet training) {
	 ...
	 */
	public BackpropagationSimple(final ContainsFlat network,
	...
	public final boolean isValidResume(final TrainingContinuation state) {
		if (!state.getContents().containsKey(BackpropagationSimple.LAST_DELTA)) {
			return false;
		}
		...
		final double[] d = (double[]) state.get(BackpropagationSimple.LAST_DELTA);
	...
	public final TrainingContinuation pause() {
		...
		result.set(BackpropagationSimple.LAST_DELTA, d);
		return result;
	}
	...
	public final void resume(final TrainingContinuation state) {
		...
		((TrainFlatNetworkBackPropagation) getFlatTraining())
				.setLastDelta((double[]) state.get(BackpropagationSimple.LAST_DELTA));
